        ...
        >
            ...
            >
                <div className="p-6 space-y-4">
                    ...
                    {/* TX error with retry */}
                    {txError && (
                        <TxErrorBlock error={txError} onRetry={() => { setTxError(null); setTxStatus('idle'); setResolvedHex(null); }} />
                    )}
                    ...
                    {txStatus === 'done' && txId && (
                        <TransactionReceipt
                            ...
                            txId={txId}
                            movements={[
                                { direction: 'debit', amount: `Option #${option.id}`, token: '', label: 'Option transferred' },
                            ]}
                            onDone={onSuccess}
                        />
                    )}
