...
const DEFAULT_PROPS = {
    ...
    onCoveredCall: vi.fn(),
    onWritePut: vi.fn(),
    collarLinkTo: '/strategies?pool=test&strategy=collar',
    onWriteCustom: vi.fn(),
};
...
describe('QuickStrategies', () => {
    ...
    it('renders Covered Call, Collar, Write Protective Put, and Write Custom cards', () => {
        renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} />);
    ...
    describe('when motoPillRatio is null', () => {
        it('Covered Call, Collar, and Write Put buttons are disabled', () => {
            renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} motoPillRatio={null} />);
    ...
    describe('Covered Call card', () => {
        it('shows computed strike at 120% of spot', () => {
            renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} motoPillRatio={50} />);
        ...
        it('calls onCoveredCall with initialValues on button click', () => {
            ...
            renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} onCoveredCall={onCoveredCall} />);
    ...
    describe('Collar card', () => {
        ...
        it('renders a link to the strategies page', () => {
            renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} />);
            const link = screen.getByTestId('strategy-collar-btn');
            expect(link.tagName).toBe('A');
            expect(link).toHaveAttribute('href', '/strategies?pool=test&strategy=collar');
        });
    });
    ...
    describe('Write Protective Put card', () => {
        ...
        it('calls onWritePut with initialValues on button click', () => {
            ...
            renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} onWritePut={onWritePut} />);
    ...
    describe('Write Custom card', () => {
        it('renders and triggers onWriteCustom callback', () => {
            ...
            renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} onWriteCustom={onWriteCustom} />);
            expect(screen.getByTestId('strategy-write-custom')).toBeInTheDocument();
        ...
        it('is disabled when wallet is not connected', () => {
            renderWithRouter(<QuickStrategies {...DEFAULT_PROPS} walletConnected={false} />);
